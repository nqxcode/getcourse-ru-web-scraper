...
exports.fetch = function(url) {
  ...
  const phantom = childProcess.execFile(phantomJsPath, childArgs, {
    env: {
      ...
      SCRAPPER_CSRF_COOKIE_NAME: process.env.SCRAPPER_CSRF_COOKIE_NAME,
      SCRAPPER_CSRF_COOKIE_VALUE: process.env.SCRAPPER_CSRF_COOKIE_VALUE,
      SCRAPPER_CSRF_COOKIE_DOMAIN: process.env.SCRAPPER_CSRF_COOKIE_DOMAIN
    },
